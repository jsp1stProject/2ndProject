  ...
  <div class="container mt-4" id="app">
    ...
    <div v-for="review in reviews" :key="review.review_no"
      ...
      <div class="d-flex align-items-center mb-2">
        <img :src="review.user.profile || '/img/default-profile.png'" class="rounded-circle me-2" width="40" height="40" alt="프로필">
      ...
      <div v-else>
        ...
        <small class="text-muted">{{ review.rev_date?.substring(0,10) }}</small>
        <div class="mt-2">
